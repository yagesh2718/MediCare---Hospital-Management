...
export function DoctorEarnings({ earnings, payouts = [] }) {
  ...
  console.log("datas" ,availableCredits)
  ...
  const platformFee = availableCredits * 10; // 10 per credit
      ...
      <Card className="border-blue-900/20">
        ...
        <CardContent className="space-y-4">
          ...
          <Alert>
            <AlertCircle className="h-4 w-4" />
            <AlertDescription className="text-sm">
              <strong>Payout Structure:</strong> You earn ₹90 per credit.
              Platform fee is ₹10 per credit. Payouts include all your available
